module github.com/Rezab98/desktop-automation-mcp
...
require (
	github.com/Rezab98/gophercon v0.0.0
	github.com/mark3labs/mcp-go v0.32.0 // or latest
)
...
replace github.com/Rezab98/gophercon => ../
